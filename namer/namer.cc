...
private:
    ...
    void deleteTypeMemberViaFullNameHash(core::MutableContext ctx, const core::FoundTypeMemberHash &oldDefHash) {
        ...
        if (oldDefHash.owner.isTypeTemplate) {
            // TODO(jez) Was there something tricky about isTypeTemplate implies "use singletonClass"?
            // (I feel like you commented on this in a recent PR...)
            // TODO(jez) Add a test with `class << self; type_member ...; end`
